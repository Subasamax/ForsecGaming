/// Helpful for database set up : https://blog.alexdevero.com/react-express-sqlite-app/
...
async function setupDatabase() {
  try {
    reset = false; // reset value determines if we want to drop the tables and start over
